...
/**
 * Servlet implementation class CommentBook
 */
...
public class CommentBook extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// ou = ud.readUserByUname("vishnu");
		 ...
		 book rl = sd.getBookByISBN(Integer.parseInt(boid));
		 commentDAO cd = new commentDAO();
		 comment c = new comment(0,String.valueOf(System.currentTimeMillis()),cuname);
